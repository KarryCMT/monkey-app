...
import {setStorage} from '@/utils/index.ts';

import icon_arrow from '@/assets/icon/icon_arrow.png';
    ...
    return (
      <>
        <View style={styles.row}>
          <Text style={styles.titleTxt}>我的栏目</Text>
          <Text style={styles.subTitleTxt}>点击进入栏目</Text>
          <TouchableOpacity
    ...
    return (
      <>
        <View style={[styles.row, {marginTop: 32}]}>
          <Text style={styles.titleTxt}>更多栏目</Text>
          <Text style={styles.subTitleTxt}>点击添加栏目</Text>
        </View>
        <View style={styles.listContent}>
